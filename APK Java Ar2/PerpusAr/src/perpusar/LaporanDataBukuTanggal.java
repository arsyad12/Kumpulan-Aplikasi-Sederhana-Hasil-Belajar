 ...
 * @author lenovo
 */
public class LaporanDataBukuTanggal extends javax.swing.JFrame {
...
JasperReport jasperreport;
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/perpusar/bg2.jpg"))); // NOI18N
        ...
        try{
         ...
         hash.put("tgl1", a);
           hash.put("tgl2", b);
            ...
            File file = new File("src/report/LaporanBukuTanggal.jrxml");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanDataBukuTanggal().setVisible(true);
            }
        });
    }
